...
$.validationEngine = {
	...
	buildPrompt : function(caller,promptText,type,ajaxed) {			// ERROR PROMPT CREATION AND DISPLAY WHEN AN ERROR OCCUR
		...
		if($.validationEngine.settings.promptPosition == "special"){
		    var formposition = $("#mcisurvey").offset();
		    var formrightpos = formposition.left + $("#mcisurvey").width();
			callerleftPosition = formrightpos;
			callerTopPosition = callerTopPosition - 8;
		}
		$(divFormError).css({
	...
	updatePromptText : function(caller,promptText,type,ajaxed) {	// UPDATE TEXT ERROR IF AN ERROR IS ALREADY DISPLAYED
		...
		$(updateThisPrompt).find(".formErrorContent").html("!");
		callerTopPosition  = $(caller).offset().top;
